...
Our diffusion model predicts 3D keypoints conditioned on 2D keypoints, without using any RGB, Depth information. Therefore, we have created a hugh training dataset only containing meta information to train the diffusion model. You can download the dataset from the [link](https://disk.pku.edu.cn/anyshare/zh-cn/link/AAF29E910587A34EAC9958FCF8C6E58EB7?_tb=none&expires_at=1970-01-01T08%3A00%3A00%2B08%3A00&item_type=file&password_required=true&title=Data_0715_2d3d.zip&type=anonymous) with password *7QOq*.
